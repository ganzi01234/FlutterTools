...
import 'package:flutter_tools/pages/game_page/src/shared_state/game/bug.dart';
import 'package:flutter_tools/pages/game_page/src/shared_state/game/task.dart';
import 'package:flutter_tools/pages/game_page/src/shared_state/game/task_pool.dart';
import 'package:flutter_tools/pages/game_page/src/shared_state/game/work_item.dart';
import 'package:flutter_tools/pages/game_page/src/widgets/work_items/bug_list_item.dart';
import 'package:flutter_tools/pages/game_page/src/widgets/work_items/task_list_item.dart';
import 'package:flutter_tools/pages/game_page/src/widgets/work_items/tasks_button_header.dart';
import 'package:flutter_tools/pages/game_page/src/widgets/work_items/tasks_section_header.dart';
        ...
        child: Consumer<TaskPool>(
          builder: (context, taskPool, _) {
            ...
            if (display == TaskPoolDisplay.all ||
              ...
              _buildSection(slivers, '进行中', scale, taskPool.workItems);
            }
