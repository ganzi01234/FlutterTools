...
class Toast {
  ...
  static showDetail(BuildContext context, String msg) {
    preToast?.dismiss();
    preToast = null;
    var overlayState = Overlay.of(context);
    var controllerShowAnim = new AnimationController(
    ...
    overlayEntry = new OverlayEntry(builder: (context) {
      return ToastWidget(
        ...
        child: buildIconToastLayout(msg),
      );
    });
    var toastView = ToastView();
    toastView.overlayEntry = overlayEntry;
  ...
  static LayoutBuilder buildIconToastLayout(String msg) {
    return LayoutBuilder(builder: (context, constraints) {
      return IgnorePointer(
        ignoring: true,
        child: Container(
